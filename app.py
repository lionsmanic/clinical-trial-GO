...
guidelines_nested = {
    "Endometrial": [
        {"id": "P-TX", "header": "初治 (Primary Tx)", "css": "p-tx", "subs": [
            ...
            {"title": "POLEmut / p53abn", "content": "POLE: 最佳預後；p53: 最差預後需積極輔助。"}]},
        {"id": "P-MT", "header": "一線維持 (1L Maint)", "css": "p-mt", "subs": [{"title": "IO Maintenance", "content": "延續一線 IO 治療後接續維持直到疾病進展 (PD)。"}]},
        {"id": "R-TX", "header": "復發治療 (Recurr Tx)", "css": "r-tx", "subs": [{"title": "Recurrent EC", "content": "標準方案：標靶+免疫 (pMMR/MSS) 或 IO 單藥 (MMRd)。"}]},
    ...
    "Cervical": [
        {"id": "P-TX", "header": "初治 (Primary Tx)", "css": "p-tx", "subs": [
            ...
            {"title": "Early Stage (Surgery)", "content": "根治性開腹術 (LACC) 或單純切除 (SHAPE)。"}]},
...
milestone_db = [
    # 子宮內膜癌
    {"cancer": "Endometrial", "pos": "P-TX", "sub_pos": ["MMRd / MSI-H / dMMR"], "name": "📚 RUBY (Dostarlimab)", "type": "Milestone", "drug": "Dostarlimab + CP", 
     "summary": "一線晚期/復發。dMMR 死亡風險降 68% (HR 0.32)；全人群 mOS 44.6m vs 28.2m (HR 0.69)。",
     "rationale": "透過 PD-1 阻斷協同化療誘導的 ICD，解決晚期 EC 長期生存困境。",
     "dosing": "Dostarlimab 500mg Q3W + CP x6週期 -> 維持 1000mg Q6W 最長 3年。",
     "inclusion": ["FIGO III-IV 期或首次復發 EC。", "包含 Carcinosarcoma / Serous 型態。"],
    ...
    {"cancer": "Endometrial", "pos": "P-TX", "sub_pos": ["NSMP / pMMR / MSS"], "name": "📚 DUO-E", "type": "Milestone", "drug": "Durvalumab ± Olaparib", 
     "summary": "一線。三藥組 PFS HR 0.57；單藥 IO 組 HR 0.77。提示 PARPi 對 pMMR 維持之協同效應。",
     "results": "pMMR 三藥組 PFS HR 0.57; dMMR 單藥維持 HR 0.42."},

    {"cancer": "Endometrial", "pos": "R-TX", "sub_pos": ["Recurrent EC"], "name": "📚 KEYNOTE-775", "type": "Milestone", "drug": "Lenvatinib + Pembrolizumab", 
     "summary": "二線。pMMR OS 17.4m vs 12.0m (HR 0.68)；5年 OS 16.7% vs 7.3%。確立 MSS 二線標準。",
    ...
    {"cancer": "Cervical", "pos": "P-TX", "sub_pos": ["CCRT (Locally Advanced)"], "name": "📚 KEYNOTE-A18", "type": "Milestone", "drug": "Pembrolizumab + CCRT", 
     "summary": "高風險 LACC。36個月 OS 82.6% vs 74.8% (HR 0.67)。確立同步免疫標準。",
     "results": "OS HR 0.67; 36m OS 82.6%."},

    {"cancer": "Cervical", "pos": "P-TX", "sub_pos": ["CCRT (Locally Advanced)"], "name": "📚 CALLA (陰性)", "type": "Milestone", "drug": "Durvalumab + CCRT", 
     "summary": "局部晚期。整體未達統計學顯著改善 (HR 0.84)。提示分流必要性。",
    ...
    {"cancer": "Cervical", "pos": "R-TX", "sub_pos": ["Recurr / Metastatic"], "name": "📚 KEYNOTE-826", "type": "Milestone", "drug": "Pembro + Chemo ± Bev", 
     "summary": "R/M 一線。全人群 OS HR 0.63；CPS≥1 HR 0.60。奠定 R/M 一線 IO 基礎。",
    ...
    {"cancer": "Cervical", "pos": "R-TX", "sub_pos": ["Recurr / Metastatic"], "name": "📚 BEATcc", "type": "Milestone", "drug": "Atezo + Chemo + Bev", 
     "summary": "R/M 一線。PFS 13.7m vs 10.4m (HR 0.62)；OS HR 0.68。",
    ...
    {"cancer": "Cervical", "pos": "P-TX", "sub_pos": ["Early Stage (Surgery)"], "name": "📚 SHAPE trial", "type": "Milestone", "drug": "Simple Hysterectomy", 
     "summary": "早期低風險(<2cm)。單純切除 3年復發率與根治術相當 (2.5% vs 2.2%)。",
    ...
    {"cancer": "Ovarian", "pos": "P-MT", "sub_pos": ["BRCA mutated", "HRD positive (wt)"], "name": "📚 ATHENA–MONO", "type": "Milestone", "drug": "Rucaparib", 
     "summary": "一線維持。ITT PFS HR 0.52 (28.7m vs 11.3m)；支持廣泛 PARPi 應用。",
    ...
    {"cancer": "Ovarian", "pos": "R-MT", "sub_pos": ["Platinum Sensitive Maint"], "name": "📚 ARIEL3", "type": "Milestone", "drug": "Rucaparib", 
     "summary": "復發維持。Rucaparib 在所有分層均顯著改善 PFS。支持二線維持。",
    ...
    {"cancer": "Ovarian", "pos": "P-MT", "sub_pos": ["HRD positive (wt)"], "name": "📚 DUO-O", "type": "Milestone", "drug": "Durva+Ola+Bev", 
     "summary": "一線。HRD+ 獲益 PFS HR 0.49。提示 IO 組合需 VEGF 與 PARPi 策略。",
    ...
    {"cancer": "Ovarian", "pos": "P-TX", "sub_pos": ["HGSC / Endometrioid"], "name": "📚 LION (NEJM 2019)", "type": "Milestone", "drug": "No Lymphadenectomy", 
     "summary": "手術。完全切除且臨床 LN 陰性，清掃無生存獲益且併發症多。",
...
ongoing_trials = [
    {"cancer": "Ovarian", "name": "FRAmework-01 (LY4170156)", "pharma": "Eli Lilly", "drug": "LY4170156 + Bevacizumab", "pos": "R-TX", "sub_pos": ["PROC (Resistant Recurrence)"], "type": "Ongoing",
     "rationale": "標靶 FRα ADC。搭載類微管蛋白 Payload。透過聯用 Bevacizumab 產生血管調節協同作用 (Synergy)，提升藥物滲透深度並殺傷低表達細胞。",
     "dosing": "LY4170156 3mg/kg IV + Bevacizumab 15mg/kg IV Q3W。",
     "inclusion": ["High-grade Serous 卵巢癌。", "經檢測確認 FRα 表達陽性。", "最後一劑鉑類後 90–180 天內惡化 (PROC)。"],
     "exclusion": ["曾用過 Topo I ADC (Enhertu)。", "具有臨床顯著蛋白尿 (UPCR ≥ 2.0)。"], "results": "Phase 3 recruitment ongoing."},
    ...
    {"cancer": "Ovarian", "name": "REJOICE-Ovarian01", "pharma": "Daiichi Sankyo", "drug": "R-DXd", "pos": "R-TX", "sub_pos": ["PROC (Resistant Recurrence)"], "type": "Ongoing",
     "rationale": "標靶 Cadherin-6 (CDH6) ADC，搭載強效 DXd 載荷。具備極高 DAR (8) 與強力旁觀者效應，專攻異質性 PROC。",
     "dosing": "R-DXd 5.6mg/kg IV Q3W。",
     "inclusion": ["HG Serous 或 Endometrioid PROC。", "提供組織切片進行 CDH6 分層判定。"],
     "exclusion": ["Low-grade 腫瘤。", "LVEF < 50%。"], "results": "Ongoing (NCT06161025)."},
    ...
    {"cancer": "Ovarian", "name": "TroFuse-021", "pharma": "MSD", "drug": "Sac-TMT (MK-2870)", "pos": "P-MT", "sub_pos": ["HRD positive (wt)", "HRD negative / pHRD"], "type": "Ongoing",
     ...
     "dosing": "Sac-TMT 5mg/kg Q3W + Bevacizumab 15mg/kg Q3W。",
     "inclusion": ["新診斷 FIGO Stage III/IV 卵巢癌。", "一線含鉑化療後達 CR 或 PR 狀態。"],
    ...
    {"cancer": "Endometrial", "name": "MK2870-033", "pharma": "MSD", "drug": "Sac-TMT + Pembrolizumab", "pos": "P-MT", "sub_pos": ["IO Maintenance"], "type": "Ongoing",
     ...
     "dosing": "Pembro 400mg Q6W + Sac-TMT 5mg/kg Q6W。",
     "inclusion": ["pMMR 子宮內膜癌 (中心檢測)。", "FIGO III/IV 一線含鉑+Pembro後達 CR/PR。"],
     "exclusion": ["子宮肉瘤 (Sarcoma)。"], "results": "Recruiting (NCT06132958)."},
]
        ...
        if st.button("🚀 開始分析"):
            if api_key and p_notes:
                try:
                    ...
                    if model:
                        prompt = f"分析病歷：{p_notes}。參考里程碑：{milestone_db} 及進行中：{ongoing_trials}。請判定階段並建議適合治療路徑與理由。"
...
# --- 7. 臨床試驗深度數據庫清單 (核心功能) ---
st.divider()
st.subheader("📋 臨床試驗深度數據庫 (請選擇研究以查看詳細 Rationale/Dosing/Eligibility)")
all_list = milestone_db + ongoing_trials
selected_name = st.selectbox("🎯 快速點選研究計畫：", [t["name"] for t in all_list if t["cancer"] == cancer_type], 
                             index=0, key="trial_selector")
...
with r1:
    ...
    st.write(f"**給藥方案:** {t.get('dosing', '詳見招募細則')}")
    st.success(t.get('rationale', '該研究機轉主要透過精準標靶或免疫調節達成存活獲益。'))
...
with r3:
    ...
    for inc in t.get('inclusion', ['詳見 Protocol。']): st.write(f"• **{inc}**")
with r4:
    ...
    for exc in t.get('exclusion', ['詳見 Protocol。']): st.write(f"• **{exc}**")
st.markdown("</div>", unsafe_allow_html=True)
