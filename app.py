    ...
    st.session_state.trials_db = [
        {
            ...
            "pos": "Recurrence", "summary": "針對 Trop-2 ADC，適用於含鉑與免疫治療後進展之患者。",
            "rationale": "標靶 Trop-2 ADC，透過 Topoisomerase I 抑制劑產生 Bystander Effect。",
        ...
        },
        {
            ...
            "rationale": "Dostarlimab 恢復 T 細胞功能，Bevacizumab 改善腫瘤微環境。",
        ...
        },
        {
            ...
            "outcomes": {"ORR": "N/A (Maint.)", "PFS": "Expect > 12m", "OS": "N/A", "AE": "ILD Risk (6%)"},
            "inclusion": ["HER2 IHC 1+/2+/3+", "BRCA WT / HRD 不適合 PARPi"],
            "exclusion": ["ILD 肺纖維化病史", "曾接受過 HER2 標靶治療", "LVEF < 50%"],
...
# --- 4. 深度資訊全覽看板 ---
st.divider()
st.subheader("🔍 第三步：深度數據、機轉與入案條件全覽")
...
with c1:
    st.markdown("<div class='section-label'>💊 給藥與藥物機轉</div>", unsafe_allow_html=True)
