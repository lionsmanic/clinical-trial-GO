...
guidelines_nested = {
    "Endometrial": [
        ...
        {"id": "P-MT", "header": "一線維持 (1L Maint)", "css": "p-mt", "subs": [{"title": "IO Maintenance", "content": "延續一線 IO 至進展。"}]},
    ...
    "Ovarian": [
        {"id": "P-TX", "header": "初治 (Primary Tx)", "css": "p-tx", "subs": [
            ...
            {"title": "Mucinous (MOC) 鑑別", "content": "CK7+/SATB2-。1. Expansile: 預後佳。 2. Infiltrative: 建議積極化療。"}]},
    ...
    "Cervical": [
        {"id": "P-TX", "header": "初治 (Primary Tx)", "css": "p-tx", "subs": [
            {"title": "Locally Advanced (CCRT)", "content": "CCRT ± 同步 IO (A18) 或誘導化療 (INTERLACE)。"},
        ...
        {"id": "R-MT", "header": "復後維持 (PR-Maint)", "css": "r-mt", "subs": [{"title": "Continuous Therapy", "content": "維持有效方案直到進展。"}]}
    ]
}

# --- 2. 實證里程碑 (📚 Milestone Library - 完整納入 Survival 數據) ---
milestone_db = [
    # Endometrial
    {"cancer": "Endometrial", "pos": "P-TX", "sub_pos": ["MMRd / MSI-H / dMMR"], "name": "📚 RUBY", "drug": "Dostarlimab + CP", 
     "summary": "一線晚期/復發。dMMR 死亡風險降 68% (HR 0.32)；全人群 mOS 44.6m vs 28.2m (HR 0.69)。",
     "results": "dMMR: HR 0.32 (PFS); mOS 44.6m (vs 28.2m).", "inclusion": ["FIGO III-IV/首次復發 EC。", "含 Carcinosarcoma / Serous 型態。"]},
    {"cancer": "Endometrial", "pos": "P-TX", "sub_pos": ["NSMP / pMMR / MSS"], "name": "📚 NRG-GY018", "drug": "Pembrolizumab + CP", 
     "summary": "一線。dMMR PFS HR 0.30；pMMR 顯著改善 (HR 0.54)。", "results": "dMMR PFS HR 0.30; pMMR HR 0.54."},
    {"cancer": "Endometrial", "pos": "P-TX", "sub_pos": ["MMRd / MSI-H / dMMR"], "name": "📚 AtTEnd", "drug": "Atezolizumab + CP", 
     "summary": "一線。dMMR 獲益明顯 (HR 0.36)；全體 OS HR 0.82。", "results": "dMMR PFS HR 0.36; ITT OS HR 0.82."},
    {"cancer": "Endometrial", "pos": "R-TX", "sub_pos": ["Recurrent EC"], "name": "📚 KEYNOTE-775", "drug": "Lenvatinib + Pembro", 
     "summary": "二線。pMMR OS 17.4m vs 12.0m (HR 0.68)；5年 OS 16.7% vs 7.3%。", "results": "pMMR OS HR 0.68; mOS 17.4m."},

    # Cervical
    {"cancer": "Cervical", "pos": "P-TX", "sub_pos": ["Locally Advanced (CCRT)"], "name": "📚 KEYNOTE-A18", "drug": "Pembrolizumab + CCRT", 
     "summary": "LACC 標準。36個月 OS 82.6% vs 74.8% (HR 0.67)。", "results": "OS HR 0.67; 36m OS 82.6%."},
    {"cancer": "Cervical", "pos": "P-TX", "sub_pos": ["Locally Advanced (CCRT)"], "name": "📚 INTERLACE", "drug": "Induction Chemo", 
     "summary": "誘導化療。Carbo/Pacli 6週接 CCRT，5年 OS 80% vs 72% (HR 0.60)。", "results": "5yr OS 80% vs 72%."},
    {"cancer": "Cervical", "pos": "P-TX", "sub_pos": ["Locally Advanced (CCRT)"], "name": "📚 CALLA (陰性)", "drug": "Durvalumab + CCRT", 
     "summary": "局部晚期。整體未達統計學顯著 PFS 改善 (HR 0.84)。", "results": "PFS HR 0.84 (P=NS)."},
    {"cancer": "Cervical", "pos": "R-TX", "sub_pos": ["Recurr / Metastatic"], "name": "📚 KEYNOTE-826", "drug": "Pembro + Chemo ± Bev", 
     "summary": "R/M 一線。全人群 OS HR 0.63；CPS≥1 HR 0.60。", "results": "OS HR 0.63 (ITT); HR 0.60 (CPS≥1)."},
    {"cancer": "Cervical", "pos": "R-TX", "sub_pos": ["Recurr / Metastatic"], "name": "📚 BEATcc", "drug": "Atezo + Chemo + Bev", 
     "summary": "R/M 一線。PFS 13.7m vs 10.4m (HR 0.62)；OS HR 0.68。", "results": "PFS HR 0.62; OS HR 0.68."},
    {"cancer": "Cervical", "pos": "R-TX", "sub_pos": ["Recurr / Metastatic"], "name": "📚 EMPOWER-Cx 1", "drug": "Cemiplimab", 
     "summary": "二線。OS 12.0m vs 8.5m (HR 0.69)；不依賴 PD-L1。", "results": "OS HR 0.69; mOS 12.0m."},
    {"cancer": "Cervical", "pos": "R-TX", "sub_pos": ["Recurr / Metastatic"], "name": "📚 innovaTV 301", "drug": "Tisotumab Vedotin", 
     "summary": "二/三線。OS 11.5m vs 9.5m (HR 0.70)，ORR 17.8%。", "results": "OS HR 0.70; ORR 17.8%."},
    {"cancer": "Cervical", "pos": "P-TX", "sub_pos": ["Early Stage (Surgery)"], "name": "📚 SHAPE trial", "drug": "Simple Hysterectomy", 
     "summary": "早期低風險。3年復發率與根治術相當 (2.5% vs 2.2%)。", "results": "3yr Recurrence: 2.5% vs 2.2%."},

    # Ovarian
    {"cancer": "Ovarian", "pos": "P-MT", "sub_pos": ["HRD positive (wt)"], "name": "📚 PAOLA-1", "drug": "Olaparib + Bevacizumab", 
     "summary": "一線維持。HRD+ 族群 5年 OS 顯著改善 (HR 0.62)。", "results": "HRD+ OS HR 0.62; 5yr OS 75.2%."},
    {"cancer": "Ovarian", "pos": "P-MT", "sub_pos": ["BRCA mutated", "HRD positive (wt)"], "name": "📚 ATHENA–MONO", "drug": "Rucaparib", 
     "summary": "一線維持。ITT PFS HR 0.52 (28.7m vs 11.3m)。", "results": "ITT PFS HR 0.52; HRD+ HR 0.47."},
    {"cancer": "Ovarian", "pos": "R-MT", "sub_pos": ["Platinum Sensitive Maint"], "name": "📚 NOVA", "drug": "Niraparib 維持", 
     "summary": "復發維持。gBRCA (HR 0.27) 與非 gBRCA (HR 0.45) 均 PFS 改善。", "results": "gBRCA HR 0.27; Non-gBRCA HR 0.45."},
    {"cancer": "Ovarian", "pos": "R-MT", "sub_pos": ["Platinum Sensitive Maint"], "name": "📚 ARIEL3", "drug": "Rucaparib 維持", 
     "summary": "復發維持。所有分層均 PFS 改善，提供二線維持實證。", "results": "BRCAm HR 0.23; HRD+ HR 0.32."},
    {"cancer": "Ovarian", "pos": "R-MT", "sub_pos": ["Platinum Sensitive Maint"], "name": "📚 SOLO2", "drug": "Olaparib (BRCA)", 
     "summary": "復發維持(BRCA)。OS 51.7m vs 38.8m (HR 0.74)。", "results": "mOS 51.7m vs 38.8m; HR 0.74."},
    {"cancer": "Ovarian", "pos": "P-MT", "sub_pos": ["HRD positive (wt)"], "name": "📚 DUO-O", "drug": "Durva+Ola+Bev", 
     "summary": "一線組合。HRD+ 組 PFS 顯著獲益 (HR 0.49)。", "results": "HRD+ PFS HR 0.49."},
    {"cancer": "Ovarian", "pos": "P-TX", "sub_pos": ["HGSC / Endometrioid"], "name": "📚 LION (NEJM 2019)", "drug": "No Lymphadenectomy", 
     "summary": "手術。完全切除且臨床 LN 陰性者，清掃無生存獲益。", "results": "OS HR 1.06; PFS HR 1.10."},
]

# --- 3. 進行中試驗 (📍 Ongoing - 完整救回 8 核心) ---
ongoing_trials = [
    {"cancer": "Ovarian", "name": "FRAmework-01 (LY4170156)", "pharma": "Eli Lilly", "drug": "LY4170156 + Bevacizumab", "pos": "R-TX", "sub_pos": ["PROC (Resistant Recurrence)"], 
     "rationale": "標靶 FRα ADC。聯用 Bevacizumab 產生血管調節與免疫重塑之協同作用 (Synergy)，提升藥物滲透並透過旁觀者效應殺傷低表達細胞。",
     "dosing": "LY4170156 3mg/kg IV + Bevacizumab 15mg/kg IV Q3W。",
     "inclusion": ["經中央實驗室確認 FRα 表達陽性。", "最後一劑鉑類後 90–180 天內惡化 (PROC)。"],
     "exclusion": ["曾用過 Topo I ADC (Enhertu)。", "活動性間質性肺病 (ILD) 或肺炎病史。"]},
    
    {"cancer": "Ovarian", "name": "REJOICE-Ovarian01", "pharma": "Daiichi Sankyo", "drug": "R-DXd", "pos": "R-TX", "sub_pos": ["PROC (Resistant Recurrence)"], 
     "rationale": "標靶 Cadherin-6 (CDH6) ADC，搭載 DXd 載荷。具備強力旁觀者效應，專攻高度異質性之 PROC 腫瘤。",
     "dosing": "R-DXd 5.6mg/kg IV Q3W。",
     "inclusion": ["HG Serous 或 Endometrioid PROC。", "先前接受 1-4 線系統治療。"],
     "exclusion": ["Low-grade / Mucinous (原發)。", "LVEF < 50%。"]},

    {"cancer": "Ovarian", "name": "TroFuse-021", "pharma": "MSD", "drug": "Sac-TMT (MK-2870)", "pos": "P-MT", "sub_pos": ["HRD positive (wt)", "HRD negative / pHRD"], 
     "rationale": "標靶 Trop-2 ADC。結合 Beva 微環境調節與 ADC 誘導之 ICD 效應，旨在優化維持階段獲益。",
     "inclusion": ["新診斷 FIGO Stage III/IV 卵巢癌。", "一線含鉑化療後達 CR 或 PR。"],
     "exclusion": ["BRCA 突變。", "先前用過 Trop-2 ADC。"]},

    {"cancer": "Endometrial", "name": "MK2870-033", "pharma": "MSD", "drug": "Sac-TMT + Pembrolizumab", "pos": "P-MT", "sub_pos": ["IO Maintenance"], 
     "rationale": "標靶 Trop-2 ADC 協同 PD-1 抑制劑。透過免疫原性調節強化 Pembro 在 pMMR 或 NSMP 族群應答。",
     "inclusion": ["pMMR 子宮內膜癌 (中心檢測確認)。", "FIGO III/IV 一線含鉑+Pembro後達 CR/PR。"],
     "exclusion": ["子宮肉瘤 (Sarcoma)。"]},
]
        ...
        if st.button("🚀 開始分析"):
            if api_key and p_notes:
                try:
                    ...
                    if model:
                        prompt = f"分析病歷：{p_notes}。參考實證：{milestone_db} 及進行中：{ongoing_trials}。提供最佳路徑。"
        ...
        for sub in stage['subs']:
            ...
            for m in rel_milestones:
                with st.popover(f"📚 {m['name']}", use_container_width=True):
                    ...
                    if st.button("📊 同步詳細報告", key=f"btn_sync_{m['name']}"):
...
# --- 7. 臨床試驗深度數據庫 (選擇器與清單) ---
st.divider()
st.subheader("📋 臨床試驗深度數據庫 (請由此選擇以查閱詳細機轉與生存數據)")
...
with r1:
    ...
    st.write(f"**核心介入物:** {t['drug']}")
    st.write(f"**給藥細節:** {t.get('dosing', t.get('regimen', '詳見 Protocol'))}")
    st.success(t.get('rationale', '該研究機轉主要透過精準分子分型，搭配標靶或免疫機制挑戰傳統 SoC 瓶頸。'))
