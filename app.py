...
# --- 1. 指引數據庫：分型、階段與 MK2870-033 標記 ---
guidelines_nested = {
    "Endometrial": [
        {"id": "P-TX", "header": "初治 (Primary Tx)", "css": "p-tx", "subs": [
            {"title": "dMMR / MSI-H / MMRd", "content": "一線首選：含鉑化療 + PD-1 (RUBY/GY018/AtTEnd)。"},
            {"title": "pMMR / NSMP / MSS", "content": "ER/Grade 分流。一線加維持 (DUO-E)。二線標靶免疫 (KN775)。"},
            {"title": "POLE mutation (超突變)", "content": "預後極佳。早期可考慮治療降階 (De-escalation)。"},
            {"title": "p53 mutation (高拷貝)", "content": "侵襲性最強。建議輔助化放療積極介入。Serous 型需檢測 HER2。"}]},
        {"id": "P-MT", "header": "一線維持 (1L Maint)", "css": "p-mt", "subs": [{"title": "Maintenance Therapy", "content": "一線 IO 治療後延續維持直到疾病進展 (PD)。包含最新 MK2870-033 計畫。"}]},
...
milestone_db = [
    {"cancer": "Endometrial", "pos": "P-TX", "sub_pos": ["dMMR / MSI-H / MMRd"], "name": "📚 RUBY (ENGOT-EN6/GOG-3031)", "pharma": "GSK", "drug": "Dostarlimab + CP", 
     ...
     "rationale": "PD-1 阻斷 (PD-1 blockade) 與含鉑化療 (Carbo/Pacli) 具備協同免疫原性細胞死亡 (ICD) 效應。",
     ...
     "outcomes": "dMMR 族群 24個月 PFS 率: 61.4% vs 15.7% (HR 0.28, 95% CI 0.16-0.50); ITT 全人群 OS HR 0.64 (95% CI 0.46-0.87)."},
    ...
    {"cancer": "Endometrial", "pos": "P-TX", "sub_pos": ["dMMR / MSI-H / MMRd", "pMMR / NSMP / MSS"], "name": "📚 NRG-GY018 (KEYNOTE-868)", "pharma": "MSD", "drug": "Pembrolizumab + CP", 
     ...
     "regimen": "Arm A: Pembrolizumab 200mg Q3W + CP x6 週期 -> 維持期: Pembrolizumab 400mg Q6W (持續 2年)。 Arm B: Placebo + CP x6 週期。",
     "inclusion": ["Stage III/IV 或復發 EC。", "提供 MMR 檢測 (IHC) 報告。"],
    ...
    {"cancer": "Endometrial", "pos": "P-MT", "sub_pos": ["pMMR / NSMP / MSS"], "name": "📚 DUO-E (ENGOT-EN9)", "pharma": "AZ", "drug": "Durvalumab + CP →維持 ± Olaparib", 
     ...
     "rationale": "探索 PARP 抑制劑 (PARPi) 與 PD-L1 抑制劑在維持階段的協同效果，PARPi 誘導的 DNA 損傷可增加免疫原性。",
     "regimen": "Arm 1: CP 控制組; Arm 2: CP+Durvalumab -> Durva 1500mg Q4W 維持; Arm 3: CP+Durvalumab -> Durva 1500mg Q4W + Olaparib 300mg bid 維持。",
     "outcomes": "pMMR Arm 3 (Ola+Durva) vs Arm 1: PFS HR 0.57 (95% CI 0.42-0.79); dMMR Arm 2 vs Arm 1: HR 0.42."},
    ...
    {"cancer": "Endometrial", "pos": "P-TX", "sub_pos": ["dMMR / MSI-H / MMRd"], "name": "📚 AtTEnd (ENGOT-EN7)", "pharma": "Roche", "drug": "Atezolizumab + CP", 
     ...
     "rationale": "驗證一線 PD-L1 抑制劑 (Atezolizumab) 併用含鉑化療之生存價值。",
     "regimen": "Arm A: Atezolizumab 1200mg Q3W + CP x6-8 週期 -> 維持 Atezolizumab 1200mg Q3W。 Arm B: Placebo + CP x6-8 週期。",
     "outcomes": "dMMR PFS: 未達到 vs 6.9m (HR 0.36); ITT mOS HR 0.82 (P=0.048)。"},
    ...
    {"cancer": "Endometrial", "pos": "R-TX", "sub_pos": ["Recurrent EC"], "name": "📚 KEYNOTE-775 (Study 309)", "pharma": "MSD/Eisai", "drug": "Lenvatinib + Pembrolizumab", 
     ...
     "rationale": "結合 VEGF-TKI 重塑血管並減輕免疫抑制，克服 MSS 患者對單藥免疫之耐藥性。",
     "regimen": "Lenvatinib 20mg QD (每日口服) + Pembrolizumab 200mg Q3W 直至進展。",
     "inclusion": ["先前接受過至少一次含鉑化療進展之晚期 EC (最多前線 2 次)。", "ECOG 0-1。", "不限 MMR 狀態。"],
     "outcomes": "pMMR OS: 17.4m vs 12.0m (HR 0.68, 95% CI 0.56-0.84); ITT OS: 18.3m vs 11.4m (HR 0.62)。"},
    ...
    {"cancer": "Endometrial", "pos": "R-TX", "sub_pos": ["Recurrent EC"], "name": "📚 GARNET", "pharma": "GSK", "drug": "Dostarlimab 單藥", 
     ...
     "outcomes": "dMMR/MSI-H ORR 45.5%; 中位 DOR 未達到。"},
    ...
    {"cancer": "Cervical", "pos": "P-TX", "sub_pos": ["Locally Advanced (CCRT)"], "name": "📚 KEYNOTE-A18 (ENGOT-cx11)", "pharma": "MSD", "drug": "Pembrolizumab + CCRT", 
     ...
     "rationale": "將免疫正式併入高風險局部晚期之根治同步化放療。",
    ...
    {"cancer": "Cervical", "pos": "R-TX", "sub_pos": ["Recurr / Metastatic"], "name": "📚 EMPOWER-Cervical 1", "pharma": "Regeneron", "drug": "Cemiplimab", 
     ...
     "outcomes": "mOS ITT: 12.0m vs 8.5m (HR 0.69)."},
    ...
    {"cancer": "Cervical", "pos": "R-TX", "sub_pos": ["Recurr / Metastatic"], "name": "📚 innovaTV 301 (ENGOT-cx12)", "pharma": "Genmab", "drug": "Tisotumab Vedotin (ADC)", 
     ...
     "rationale": "標靶組織因子 (TF) ADC，解決後線化療耐藥瓶頸。",
    ...
    {"cancer": "Cervical", "pos": "P-TX", "sub_pos": ["Early Stage (Surgery)"], "name": "📚 SHAPE trial", "pharma": "CCTG", "drug": "Simple Hysterectomy", 
     ...
     "outcomes": "3yr Pelvic Recurrence: 2.5% (SH) vs 2.2% (RH) (HR 1.12)."},
    ...
    {"cancer": "Ovarian", "pos": "P-MT", "sub_pos": ["HRD positive / BRCA wt", "HRD negative (pHRD)"], "name": "📚 PRIMA (ENGOT-OV26)", "pharma": "GSK", "drug": "Niraparib Maint", 
     ...
     "rationale": "不限 BRCA 突變，擴大 PARPi 在一線含鉑化療後的獲益群眾。",
    ...
    {"cancer": "Ovarian", "pos": "P-MT", "sub_pos": ["HRD positive / BRCA wt"], "name": "📚 PAOLA-1 (ENGOT-ov25)", "pharma": "AZ", "drug": "Olaparib + Bevacizumab", 
     ...
     "rationale": "結合 PARPi 與 anti-VEGF 維持路徑。",
    ...
    {"cancer": "Ovarian", "pos": "P-MT", "sub_pos": ["BRCA mutation", "HRD positive / BRCA wt"], "name": "📚 ATHENA–MONO", "pharma": "Clovis", "drug": "Rucaparib Maint", 
     ...
     "outcomes": "HRD+ PFS: 28.7m vs 11.3m (HR 0.47)."},
    ...
    {"cancer": "Ovarian", "pos": "R-MT", "sub_pos": ["PARPi Maint"], "name": "📚 NOVA", "pharma": "GSK", "drug": "Niraparib 復發維持", 
     ...
     "outcomes": "gBRCA PFS: 21.0m vs 5.5m (HR 0.27)."},
    ...
    {"cancer": "Ovarian", "pos": "R-MT", "sub_pos": ["PARPi Maint"], "name": "📚 ARIEL3", "pharma": "Clovis", "drug": "Rucaparib 復發維持", 
     ...
     "outcomes": "BRCAm mPFS 16.6m vs 5.4m."},
    ...
    {"cancer": "Ovarian", "pos": "P-MT", "sub_pos": ["HRD positive / BRCA wt"], "name": "📚 DUO-O", "pharma": "AZ", "drug": "Durva+Ola+Bev 維持", 
     ...
     "outcomes": "HRD+ PFS HR 0.49 (95% CI 0.34-0.69)."},
    ...
    {"cancer": "Ovarian", "pos": "R-TX", "sub_pos": ["PROC (Resistant Recur)"], "name": "📚 MIRASOL (GOG-3045)", "pharma": "ImmunoGen", "drug": "Mirvetuximab Soravtansine", 
     ...
     "rationale": "針對 FRα 高表現 PROC 患者，首個具備 OS 獲益研究。",
     "regimen": "Arm A: Mirvetuximab 6.0 mg/kg (AIBW) IV Q3W 直至進展。 Arm B: 醫師選擇化療。"},
    ...
    {"cancer": "Ovarian", "pos": "R-TX", "sub_pos": ["PSOC (Sensitive Recur)"], "name": "📚 DESKTOP III", "pharma": "AGO", "drug": "Secondary Cytoreduction Surgery", 
     ...
     "rationale": "嚴選 AGO Score 合格患者二次手術具顯著 OS 獲益。",
     "inclusion": ["首次鉑類敏感復發 (PFI > 6m)。", "AGO Score 陽性 (完全切除潛力)。"],
     "outcomes": "ITT mOS: 53.7m vs 46.0m (HR 0.75)."},
    ...
    {"cancer": "Ovarian", "pos": "P-TX", "sub_pos": ["HGSC / Endometrioid"], "name": "📚 LION", "pharma": "NEJM", "drug": "No Lymphadenectomy", 
     ...
     "outcomes": "mOS: 65.5m vs 69.2m (HR 1.06)."},
]

# --- 3. 極量化資料庫：8 項進行中試驗 (招募中) ---
ongoing_trials = [
    {"cancer": "Endometrial", "name": "📍 MK2870-033", "pharma": "MSD", "drug": "Sac-TMT + Pembrolizumab", "pos": "P-MT", "sub_pos": ["Maintenance Therapy"], "type": "Ongoing",
     ...
     "rationale": "標靶 Trop-2 ADC (Sac-TMT) 誘導之 ICD 改善微環境，強化 PD-1 抑制劑在 pMMR/MSS 患者的應答深度。",
     "regimen": "Arm A: Sac-TMT 5mg/kg Q3W + Pembrolizumab 400mg Q6W 維持治療直至進展。 Arm B: 醫師選擇維持方案 (對照組)。",
     "inclusion": ["新診斷 pMMR/MSS 子宮內膜癌 (中央 IHC 檢測)。", "FIGO III-IV 期、一線含鉑化療 + Pembrolizumab 後達 CR/PR。"],
     "exclusion": ["先前接受過系統性 IO 治療。", "子宮肉瘤 (Sarcoma)。"]},
    ...
    {"cancer": "Ovarian", "name": "📍 FRAmework-01 (LY4170156)", "pharma": "Eli Lilly", "drug": "LY4170156 + Bevacizumab", "pos": "R-TX", "sub_pos": ["PROC (Resistant Recur)", "PSOC (Sensitive Recur)"], "type": "Ongoing",
     ...
     "rationale": "標靶 FRα ADC 聯用 anti-VEGF 產生血管重塑協同作用，提升滲透深度挑戰耐藥瓶頸。",
     "regimen": "分組設計： Arm A (PROC): LY 3.0mg/kg + Bev 15mg/kg Q3W; Arm B (PROC): LY 4.0mg/kg + Bev 15mg/kg Q3W; Arm C (PSOC PFI 6-12m): LY 3.0mg/kg + Bev 15mg/kg Q3W。",
     "inclusion": ["經檢測確認 FRα 陽性 (IHC)。", "最後鉑類後進展之 PROC 或 PSOC (PFI 90d-365d)。"],
    ...
    {"cancer": "Endometrial", "name": "📍 GU-US-682-6769", "pharma": "Gilead", "drug": "SG (Trodelvy)", "pos": "R-TX", "sub_pos": ["Recurrent EC"], "type": "Ongoing",
     ...
     "rationale": "標靶 Trop-2 ADC 利用 SN-38 載荷引發強力 DNA 損傷，專攻鉑類與免疫失敗之救援。",
     "regimen": "Sacituzumab govitecan 10mg/kg (Day 1, Day 8) 每 21 天為一週期 (Q21D)。"},

    {"cancer": "Ovarian", "name": "📍 DOVE", "pharma": "GSK", "drug": "Dostarlimab + Bevacizumab", "pos": "R-TX", "sub_pos": ["PROC (Resistant Recur)"], "type": "Ongoing",
     "rationale": "針對 OCCC 透明細胞癌。組合 IO + anti-VEGF 旨在誘導對免疫抑制環境的應答。",
    ...
    {"cancer": "Ovarian", "name": "📍 DS8201-772 (Enhertu)", "pharma": "AstraZeneca", "drug": "T-DXd", "pos": "P-MT", "sub_pos": ["BRCA mutation", "HRD positive (wt)"], "type": "Ongoing",
     "rationale": "利用 T-DXd 極高 DAR (8) 優勢清除化療後殘餘之 HER2 表現微小病灶。",
     "regimen": "Trastuzumab deruxtecan 5.4mg/kg IV Q3W。"},
    ...
    {"cancer": "Ovarian", "name": "📍 REJOICE-Ovarian01", "pharma": "Daiichi Sankyo", "drug": "R-DXd", "pos": "R-TX", "sub_pos": ["PROC (Resistant Recur)"], "type": "Ongoing",
     "rationale": "標靶 CDH6 ADC，挑戰高度異質性 PROC。",
     "regimen": "Raludotatug deruxtecan 5.6mg/kg IV Q3W。"},

    {"cancer": "Ovarian", "name": "📍 TroFuse-021", "pharma": "MSD", "drug": "Sac-TMT (MK-2870) + Bev", "pos": "P-MT", "sub_pos": ["HRD negative (pHRD)"], "type": "Ongoing",
     "rationale": "標靶 Trop-2 ADC 優化一線維持獲益。"},

    {"cancer": "Cervical", "name": "📍 innovaTV 301 Access", "pharma": "Genmab", "drug": "Tivdak", "pos": "R-TX", "sub_pos": ["Recurr / Metastatic"], "type": "Ongoing",
     "rationale": "擴大 TF ADC 在復發患者中的應用。"},
]
...
with st.sidebar:
    ...
    with st.expander("✨ 患者病歷數據深度分析", expanded=True):
        p_notes = st.text_area("輸入摘要 (含分期/細胞/標記)", placeholder="例如：EC Stage III, dMMR, p53 mutation...", height=250)
        if st.button("🚀 開始媒合分析"):
            if api_key and p_notes:
                try:
                    genai.configure(api_key=api_key)
                    available_models = [m.name for m in genai.list_models() if 'generateContent' in m.supported_generation_methods]
                    target_model = next((m for m in available_models if 'gemini-1.5-flash' in m), "gemini-pro")
                    model = genai.GenerativeModel(target_model)
                    prompt = f"分析病歷：{p_notes}。請參考實證庫：{milestone_db + ongoing_trials}。建議適合路徑與理由。"
        ...
        for sub in stage['subs']:
            ...
            for t in rel_trials:
                ...
                with st.popover(label, use_container_width=True):
                    st.success(f"**結論摘要:** {t.get('results_short', '招募中/詳見看板')}")
...
if not filtered_names:
    ...
    selected_name = st.selectbox("🎯 快速選擇研究計畫以查閱細節：", filtered_names, index=curr_idx, key="trial_selector")
    st.session_state.selected_trial = selected_name
    t_obj = next(it for it in all_list if it["name"] == selected_name)
    ...
    with r1:
        ...
        st.markdown("<div class='regimen-box'><b>分組給藥方式 (Regimen per Arm):</b><br>" + t_obj.get('regimen', '補齊中。') + "</div>", unsafe_allow_html=True)
        
        st.success(f"**科學理據 (Scientific Rationale):** {t_obj.get('rationale', '提升存活獲益。')}")

    with r2:
        st.markdown("<div style='background:#FFF8E1; border-left:8px solid #FBC02D; padding:15px; border-radius:10px;'><b>📈 Key Evidence (最新生存與緩解指標)</b></div>", unsafe_allow_html=True)
        st.markdown(f"""
            <div style='text-align:center; background:white; padding:15px; border:2px solid #FFE082; border-radius:12px;'>
                ...
                <div class='hr-big-val'>{t_obj.get('outcomes', t_obj.get('results_short', 'Ongoing'))}</div>
            </div>
        """, unsafe_allow_html=True)
    ...
    with r4:
        ...
        for exc in t_obj.get('exclusion', ['排除臟器功能異常。']): st.write(f"• **{exc}**")
    st.markdown("</div>", unsafe_allow_html=True)
